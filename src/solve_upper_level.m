...
while counter <= 1000
    if size(divp_updated, 1) == 0
        [divp, pk, A, alpha10_c, alpha01_c] = solve_lower_level(f_noise, alpha, XX1, YY1, XX2, YY2);
    ...
    J_prime = 1 / eps * diag(arrayfun(@(r)dd_smooth_pen(r, delta), pk_norm - [alpha01_c; alpha10_c])) * qk;  % does this depend on alpha_10c and alhpha01c
    ...
    while true
        ...
        [divp_updated, pk, A, alpha10_c, alpha01_c] = solve_lower_level(f_noise, alpha_updated, XX1, YY1, XX2, YY2);
        
        ssim(f_noise + divp_updated, f)
